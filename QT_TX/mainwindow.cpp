...
void MainWindow::BEGIN_ACTION(void)
{
    if(WORK_status == false)
    {
        ...
        QString stest_times;
        QString sdistance;
        sprintf_s(ctest_times,"%d",test_times);
        sprintf_s(cmessage_length,"%d",message_length);
        ...
        //}else
        if(!TXfile.open(QFile::WriteOnly |QIODevice::Truncate)){
